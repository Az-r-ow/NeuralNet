...
namespace NeuralNet
{
  ...
  public:
     ...
     * it comes with a set of methods to manipulate the data to your liking for better training optimization.
     *
    ...
    /**
     * @brief This method will separate the inputs and labels data into batches of the specified size
     *
