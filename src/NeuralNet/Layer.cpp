...
void Layer::randomWeightInit(Eigen::MatrixXd *weights, double min, double max)
{
...
void Layer::randomDistWeightInit(Eigen::MatrixXd *weights, double mean, double stddev)
{
