...
void CHECK_MATRIX_VALUES_IN_RANGE(Eigen::MatrixXd matrix, double min, double max)
{
  for (int i = 0; i < matrix.rows(); i++)
  {
...
void CHECK_MATRIX_APPROX(const Eigen::MatrixXd &matA, const Eigen::MatrixXd &matB, double epsilon = 1e-6)
{
